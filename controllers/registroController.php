...
class registroController extends Controller {
    ...
    public function __construct() {
        parent::__construct();
        /*
         * Carga en la variable local $_registro el modelo con onmbre registroModel.php
         */
    ...
    public function index() {
        /*
         * Si el usuario está logeado y ha accedido al método registro
         * lo redirecciona al index por defecto.
         */
        ...
        if ($this->getInt('enviar') == 1) {
            ...
            $this->_registro->registrarUsuario(
                    $this->getSql('nombre'), $this->getAlphaNum('usuario'), $this->getSql('pass'), $this->getPostParam('email')
            );
